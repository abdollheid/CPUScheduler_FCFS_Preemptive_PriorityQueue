...
//       again.setLayoutY(5*pane.getHeight()/13);
            ...
            FlowPane container2 = new FlowPane();
            container2.setAlignment(Pos.CENTER);
            Label doc3 = new Label("Amr Mohamed");
            doc3.setStyle("-fx-font-size:20px ; -fx-text-fill:blue;");
            container2.getChildren().add(doc3);
            ...
            pane.getChildren().addAll(head, container0, container1, container2, bc);
            Scene scene = new Scene(pane, Screen.getPrimary().getVisualBounds().getWidth(), Screen.getPrimary().getVisualBounds().getHeight());
